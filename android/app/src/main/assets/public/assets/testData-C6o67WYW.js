import{p as s}from"./index-HfbygEp5.js";import"./vendor-motion-DNtv-BOp.js";import"./vendor-radix-CXwGJ_fK.js";import"./vendor-genai-BN8tTqBV.js";const c=()=>{console.log("🎵 Creating test song data from public assets...");const t=`1
...
I only find the path when I refuse to be my passion's friend.`,r=s(t),o=[{file:"lyric-art-Intro - Melancholic.png",section:"Intro",mood:"Melancholic",time:0},{file:"lyric-art-Verse 1 - Somber.png",section:"Verse 1",mood:"Somber",time:51},{file:"lyric-art-Verse 2 - Contemplative.png",section:"Verse 2",mood:"Contemplative",time:119},{file:"lyric-art-Bridge 1 - Urgent Caution.png",section:"Bridge 1",mood:"Urgent Caution",time:183},{file:"lyric-art-Chorus_Outro 1 - Serene Wonder.png",section:"Chorus_Outro 1",mood:"Serene Wonder",time:203},{file:"lyric-art-Interlude - Ethereal Lament.png",section:"Interlude",mood:"Ethereal Lament",time:229},{file:"lyric-art-Verse 3 - Grand Melancholy.png",section:"Verse 3",mood:"Grand Melancholy",time:289},{file:"lyric-art-Bridge 2 - Hopeful Instruction.png",section:"Bridge 2",mood:"Hopeful Instruction",time:298},{file:"lyric-art-Verse 4 - Solitary Desolation.png",section:"Verse 4",mood:"Solitary Desolation",time:326},{file:"lyric-art-Outro 2 - Blissful Climax.png",section:"Outro 2",mood:"Blissful Climax",time:340},{file:"lyric-art-Outro 3 - Resolute Struggle.png",section:"Outro 3",mood:"Resolute Struggle",time:364}],a=o.map((e,i)=>({id:`prompt-test-${i}`,text:`A ${e.mood.toLowerCase()} scene representing the ${e.section.toLowerCase()} of the song`,mood:`${e.section} - ${e.mood}`,timestamp:l(e.time),timestampSeconds:e.time})),n=o.map((e,i)=>({promptId:`prompt-test-${i}`,imageUrl:`/test_data/${e.file}`}));return console.log(`✨ Loaded ${a.length} test prompts with actual images`),{fileName:"the true Saba.mp3",audioUrl:"/test_data/the true Saba.mp3",srtContent:t,parsedSubtitles:r,prompts:a,generatedImages:n}},l=t=>{const r=Math.floor(t/60),o=Math.floor(t%60);return`${r.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`};export{c as createTestSongData};
